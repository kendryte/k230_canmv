...
#udp client ok --187 Kbits/sec
#tcp client ok --249 Kbits/sec
#server tcp-- 250 Kbits/sec
#server udp -- 187Kbits/sec.
def main():
    # opt_mode = None
    # #-s -c
    # opt_udp = False
...
#         # if  sock :
#         #     print(sock.fileno(), pollable[0],sock)
#         return sock is not None and pollable[0] == sock
