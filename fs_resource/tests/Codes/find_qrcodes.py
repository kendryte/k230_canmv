...
def capture_picture():
    ...
    while True:
        ...
        try:
            ...
            codes = dect_img.find_qrcodes()
            for code in codes:
                rect = code.rect()
                draw_img.draw_rectangle([v*SCALE for v in rect], color=(255, 0, 0), thickness = 5)
                draw_img.draw_string_advanced(rect[0] * SCALE, rect[1] * SCALE, 32, code.payload())
                print(code)
