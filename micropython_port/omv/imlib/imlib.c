...
size_t image_size(image_t *ptr) {
    switch (ptr->pixfmt_id) {
        case PIXFORMAT_ID_BINARY:
            return IMAGE_BINARY_LINE_LEN_BYTES(ptr) * ptr->h;
        case PIXFORMAT_ID_GRAY:
        case PIXFORMAT_ID_RGB565:
        case PIXFORMAT_ID_BAYER:
        case PIXFORMAT_ID_YUV422:
        case PIXFORMAT_ID_ARGB8:
        case PIXFORMAT_ID_RGB8:
            return ptr->w * ptr->h * ptr->bpp;
        case PIXFORMAT_ID_YUV420:
            return ptr->w * ptr->h * 3 / 2;
        case PIXFORMAT_ID_JPEG:
        case PIXFORMAT_ID_PNG:
            return ptr->size;
        default:
            return 0;
    }
