...
typedef enum {
    ...
    SUBFORMAT_ID_YUV420 = 0,
    SUBFORMAT_ID_YVU420 = 1,
    SUBFORMAT_ID_ARGB   = 0,
    SUBFORMAT_ID_ABGR   = 1,
    SUBFORMAT_ID_RGBA   = 2,
    SUBFORMAT_ID_BGRA   = 3,
...
typedef enum {
    ...
    PIXFORMAT_BPP_YUV420 = (2 << 4) | 3,
    PIXFORMAT_BPP_ARGB8  = 4,
    PIXFORMAT_BPP_RGB8   = 3,
    /* Note: Update PIXFORMAT_IS_VALID when adding new formats */
} pixformat_bpp_t;
...
typedef enum {
  ...
  PIXFORMAT_ARGB8      = (PIXFORMAT_FLAGS_CM | (PIXFORMAT_ID_ARGB8  << 16) | (SUBFORMAT_ID_ARGB   << 8) | PIXFORMAT_BPP_ARGB8  ),
  PIXFORMAT_ARGB8888   = (PIXFORMAT_FLAGS_CM | (PIXFORMAT_ID_ARGB8  << 16) | (SUBFORMAT_ID_ARGB   << 8) | PIXFORMAT_BPP_ARGB8  ),
  PIXFORMAT_ABGR8888   = (PIXFORMAT_FLAGS_CM | (PIXFORMAT_ID_ARGB8  << 16) | (SUBFORMAT_ID_ABGR   << 8) | PIXFORMAT_BPP_ARGB8  ),
  PIXFORMAT_RGBA8888   = (PIXFORMAT_FLAGS_CM | (PIXFORMAT_ID_ARGB8  << 16) | (SUBFORMAT_ID_RGBA   << 8) | PIXFORMAT_BPP_ARGB8  ),
  PIXFORMAT_BGRA8888   = (PIXFORMAT_FLAGS_CM | (PIXFORMAT_ID_ARGB8  << 16) | (SUBFORMAT_ID_BGRA   << 8) | PIXFORMAT_BPP_ARGB8  ),
  PIXFORMAT_RGB8       = (PIXFORMAT_FLAGS_CM | (PIXFORMAT_ID_RGB8   << 16) | (SUBFORMAT_ID_RGB    << 8) | PIXFORMAT_BPP_RGB8   ),
  PIXFORMAT_RGB888     = (PIXFORMAT_FLAGS_CM | (PIXFORMAT_ID_RGB8   << 16) | (SUBFORMAT_ID_RGB    << 8) | PIXFORMAT_BPP_RGB8   ),
  PIXFORMAT_BGR888     = (PIXFORMAT_FLAGS_CM | (PIXFORMAT_ID_RGB8   << 16) | (SUBFORMAT_ID_BGR    << 8) | PIXFORMAT_BPP_RGB8   ),
  PIXFORMAT_RGBP888    = (PIXFORMAT_FLAGS_CM | (PIXFORMAT_ID_RGB8   << 16) | (SUBFORMAT_ID_RGBP   << 8) | PIXFORMAT_BPP_RGB8   ),
  PIXFORMAT_BGRP888    = (PIXFORMAT_FLAGS_CM | (PIXFORMAT_ID_RGB8   << 16) | (SUBFORMAT_ID_BGRP   << 8) | PIXFORMAT_BPP_RGB8   ),
