...
def k_vdec_supplement_info(**kwargs):
    ...
    vdec_def.k_vdec_supplement_info_parse(s, kwargs)
    return s
...
def k_vdec_stream(**kwargs):
    ...
    vdec_def.k_vdec_stream_parse(s, kwargs)
    return s
...
def k_vdec_dec_err(**kwargs):
    ...
    vdec_def.k_vdec_dec_err_parse(s, kwargs)
    return s
...
def k_vdec_chn_status(**kwargs):
    ...
    vdec_def.k_vdec_chn_status_parse(s, kwargs)
    return s
...
def k_vdec_dsl_size(**kwargs):
    ...
    vdec_def.k_vdec_dsl_size_parse(s, kwargs)
    return s
...
def k_vdec_dsl_ratio(**kwargs):
    ...
    vdec_def.k_vdec_dsl_ratio_parse(s, kwargs)
    return s
...
def k_vdec_downscale(**kwargs):
    ...
    vdec_def.k_vdec_downscale_parse(s, kwargs)
    return s
